function [Cti,Ati,Vf,Ap] = valueg(beta,sigma,r,w,A,tol,pro,tr, L, tau)
...
while e > tol
    ...
    for i = 1 : length(pro)
            ...
            Caux = (1+r).*A' + w*(1 - tau)*pro(i) - A + tau*L; %Consumption
            Caux(Caux<=0) = NaN;  
...
Cti = (1+r)*A + w*(1 - tau)*pro - A(Ap')+ tau*L; %Optimal consumption
